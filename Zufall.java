...
public class Zufall {				
    ...
    private static String[] geschenke = {"Spannendes Buch", "Robuster Nussknacker", "Schnelles Auto", "Stacheliger Kaktus", "Duftende Badesalze", "Leckerer Essensgutschein", "Kroegis Autogramm"};

	private static String[] essbares = {"Schoko-Nikolaus", "Knusprige Kekse", "Aromatischer Tee", "Selbstgemachtes Pesto", "Leckere Papaya", "Saftige Kekse", "Kroegi-Keks"};
